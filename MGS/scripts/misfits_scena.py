...
model_map(polygons=blocks, vals=10 ** resmod, log=1, cbpos=bpos, aspect=1,
...
model_map(polygons=blocks, vals=ipmod / m2p, log=0, cbpos=bpos,
          levels=ip_levels, binned=False,
          folder=result_folder, fontsize=10, labelsize=labelsize,
          figname=None, extension='pdf')
plt.show()

results_dir = jp('/Users/robin/PycharmProjects/MGS', 'results/paper/scenario/WFB')
...
model_map(polygons=blocks, vals=rtp, log=1, cbpos=bpos, levels=res_levels, folder=result_folder,
          figname=None, fontsize=10, labelsize=labelsize, extension='pdf')
plt.show()
...
# %% WFA
results_dir = jp('/Users/robin/PycharmProjects/MGS', 'results/paper/scenario/WFA')
subs = ''
result_folder = jp(results_dir, subs)
