...
model_map(polygons=blocks, vals=10**resmod, log=1, cbpos=0.35,
          levels=res_levels, binned=False,
          folder=result_folder,  fontsize=10, labelsize=12,
          figname='res_mod', extension='pdf')
plt.show()
...
model_map(polygons=blocks, vals=rtp, log=1, cbpos=0.35, levels=res_levels,
          folder=result_folder, figname='res', fontsize=10, labelsize=12, extension='pdf')
plt.show()
...
model_map(polygons=blocks, vals=rtp, log=1, cbpos=0.35, levels=res_levels, folder=result_folder,
          figname='res_mgs', fontsize=10, labelsize=12, extension='pdf')
plt.show()
